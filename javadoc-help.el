...
;;      Removed the autoload instruction in the documentation since autoload doesn't work well with after-init-hook.
;;      Moved command instruction up front in the Manage Javadoc URL screen.
;;      Fixed the bug of running inhibit-read-only on all buffers, (thanks to Colin Fraizer).
;;      Version 1.1
;;
...
(defconst jdh--jmenu-table-offset 16)
